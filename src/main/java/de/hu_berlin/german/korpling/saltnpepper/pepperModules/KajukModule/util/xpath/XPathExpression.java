package de.hu_berlin.german.korpling.saltnpepper.pepperModules.KajukModule.util.xpath;
...
public class XPathExpression {
	...
	public static Boolean matches(XPathExpression xPathExpression1, XPathExpression xPathExpression2)
	{
		if (	(xPathExpression1== null)||
			...
			throw new NullPointerException("Cannot match against an empty XPath expression.");
